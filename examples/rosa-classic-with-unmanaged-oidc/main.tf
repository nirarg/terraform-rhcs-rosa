...
module "oidc_provider" {
  ...
  managed            = false
  secret_arn         = module.oidc_config_resources.secret_arn
  issuer_url         = module.oidc_config_resources.issuer_url
...
module "rosa_cluster_classic" {
  ...
  //   private_subnets       = module.vpc_private.private_subnets
